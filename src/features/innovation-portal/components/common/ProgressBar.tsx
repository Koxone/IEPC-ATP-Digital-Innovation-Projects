    ...
    <div className="flex flex-col gap-1.5">
      {showLabel && (
        <div className="flex items-center justify-between text-[11px] font-medium text-ford-text-muted">
          <span className="tracking-wider text-ford-text-dim uppercase">Delivery progress</span>
          <span className="font-semibold text-white tabular-nums">{safeValue}%</span>
        </div>
      )}
      <div className={`w-full overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10 ring-inset ${heights}`}>
        <div
